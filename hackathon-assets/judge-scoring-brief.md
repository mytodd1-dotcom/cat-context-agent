...
| The submission is reproducible. | A one-command reproduction receipt reruns submission verification and artifact validation with all checks passing. | `hackathon-assets/reproduction-receipt.md`<br>`hackathon-assets/judge-walkthrough.md`<br>`hackathon-assets/judge-faq.md`<br>`hackathon-assets/judge-quick-card.md`<br>`hackathon-assets/submission-readiness-report.md`<br>`hackathon-assets/artifact-validation-report.md`<br>`hackathon-assets/submission-honesty-audit.md` |
...
- The current evidence chain is reproducible with 3 requests and 19 artifact validation checks.
